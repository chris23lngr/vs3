...
To interact with the storage provider you need to create an adapter. See [Adapters](/docs/adapters/overview) for a full list of supported adapters.
...
- [Adapters](/docs/adapters/overview) for connecting to your storage provider.
- [Configuration](/docs/configuration) for additional options.
- [Usage](/docs/usage) for more information on how to use the client and server APIs.