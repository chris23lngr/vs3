...
To interact with the storage provider you need to create an adapter. See [Adapters](/docs/adapters) for a full list of supported adapters.
...
<CodeTabs groupId="frontend-framework" defaultValue="react" values={["react"]}>
