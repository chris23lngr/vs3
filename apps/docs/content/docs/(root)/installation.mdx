...
While this will work without any other options you might want to pass in some additional options. Check out [Storage Options](/docs/server/storage-options) for more information.
...
Mount the handlers to your framework of choice at `/api/storage/[...all]`. If you prefer to use a different path, you can pass the `apiPath` option when creating the storage instance. See [Storage Options](/docs/server/storage-options) for more information.
...
That's it! You can now use `vs3` to upload and download files. Check out [Client Overview](/docs/client/overview) for more information on how to use the client and server APIs.
...
- [Adapters](/docs/server/adapters) for connecting to your storage provider.
- [Storage Options](/docs/server/storage-options) for additional options.
- [Client Overview](/docs/client/overview) for more information on how to use the client and server APIs.
